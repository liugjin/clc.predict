    ...
    EventManagerDirective.prototype.show = function(scope, element, attrs) {
      ...
      scope.selectParent = (function(_this) {
        return function(station) {
          ...
          return scope.stations = (_ref1 = (_ref2 = station.parentStation) != null ? _ref2.stations : void 0) != null ? _ref1 : scope.predicts;
        };
      })(this);
      ...
      statisticEvents = function() {
        var all, event, k, key, predict, predictCounts, predictSeverities, predictStatistic, station, stationCounts, stationSeverities, stationStatistic, statistic, statisticType, type, v, _i, _j, _len, _len1, _ref3, _ref4, _ref5, _ref6, _ref7, _results;
        all = getStatistic();
        scope.statistics = {};
          ...
          _results.push((function() {
            ...
            for (_k = 0, _len2 = _ref8.length; _k < _len2; _k++) {
              ...
              for (k in stationSeverities) {
                ...
                predictSeverities[k] = ((_ref9 = predictSeverities[k]) != null ? _ref9 : 0) + v;
              }
              ...
              _results1.push((function() {
                ...
                for (key in _ref10) {
                  ...
                  if (predictStatistic.types.hasOwnProperty(type.type)) {
                    ...
                    _results2.push(predictStatistic.types[type.type] = {
                      type: type.type,
                      count: type.count,
      ...
      scope.selectPredict = (function(_this) {
      ...
      scope.selectChild(((_ref4 = scope.predict) != null ? _ref4.stations[0] : void 0) || ((_ref5 = scope.project) != null ? (_ref6 = _ref5.stations) != null ? _ref6.items[0] : void 0 : void 0));
      return scope.selectPredict(scope.predicts[0]);
    };
