    ...
    PlantaskCardDirective.prototype.show = function(scope, element, attrs) {
      ...
      return scope.$watch("parameters", (function(_this) {
        return function(param) {
          var count, excepworkitem, excepworkitemCounts, handlecounts, list, ringItem, taskItem, workItem, workitemCounts, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4;
          if (!param) {
            return;
          }
          ...
          workitemCounts = 0;
          _ref2 = param.data.workitems;
          for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
            workItem = _ref2[_j];
            workitemCounts += workItem.val;
          }
          excepworkitemCounts = 0;
          _ref3 = param.data.excepworkitems;
          for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
            excepworkitem = _ref3[_k];
            excepworkitemCounts += excepworkitem.val;
          }
          _ref4 = scope.rignData;
