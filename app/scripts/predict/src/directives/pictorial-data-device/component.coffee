...
define ['../base-directive','text!./style.css', 'text!./view.html', 'underscore', "moment", "./swiper/swiper.min"], (base, css, view, _, moment, swiper) ->
  ...
  class PictorialDataDeviceDirective extends base.BaseDirective
    ...
    show: (scope, element, attrs) =>
      ...
      setTimeout =>
        mySwiper = new Swiper '.swiper-container', {height:100,slidesPerView: 'auto', spaceBetween: 15, freeMode: true, loop: false, observer: true, observeParents: true, normalizeSlideIndex: false, centeredSlides : false}
      ,2000
      scope.devices = {}
    ...
    filterEquipments: (scope, equips) =>
      ...
      for equip in equips
        ...
        scope.signals[key] = {severity: {name:"设备状态", value: -2, formatValue: "未知"}} if not scope.signals[key]
