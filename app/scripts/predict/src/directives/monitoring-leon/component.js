...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var MonitoringLeonDirective, exports;
  MonitoringLeonDirective = (function(_super) {
    __extends(MonitoringLeonDirective, _super);

    function MonitoringLeonDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "monitoring-leon";
      MonitoringLeonDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    MonitoringLeonDirective.prototype.setScope = function() {};

    MonitoringLeonDirective.prototype.setCSS = function() {
      return css;
    };

    MonitoringLeonDirective.prototype.setTemplate = function() {
      return view;
    };

    MonitoringLeonDirective.prototype.show = function(scope, element, attrs) {
    ...
    MonitoringLeonDirective.prototype.selectStation = function(scope, station, firstLoad) {
    ...
    MonitoringLeonDirective.prototype.loadStationEquipStatistics = function(scope, station, callback) {
    ...
    MonitoringLeonDirective.prototype.filterStationStatistic = function(station, statistic, callback) {
    ...
    MonitoringLeonDirective.prototype.computeStationStatistic = function(scope, station) {
    ...
    MonitoringLeonDirective.prototype.selectType = function(scope, type, callback, refresh) {
    ...
    MonitoringLeonDirective.prototype.resize = function(scope) {};

    MonitoringLeonDirective.prototype.dispose = function(scope) {
    ...
    return MonitoringLeonDirective;
