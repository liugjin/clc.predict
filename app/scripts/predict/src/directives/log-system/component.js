      ...
      scope.queryLog = function(para) {
        ...
        return $.get('getConfigurationInfo', {
          ...
          _.map(data.data, function(item) {
            var action2, operation, type, _ref10;
            if (item.type === 'equipment') {
              ...
              if ((_ref10 = item.topic.split('/')[2], __indexOf.call(scope.controller.role.stations, _ref10) >= 0) || scope.controller.role.stations.indexOf('_all') > -1) {
