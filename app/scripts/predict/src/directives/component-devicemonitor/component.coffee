###
* File: component-devicemonitor-directive
* User: James
* Date: 2019/03/13
* Desc:
###
...
define ['../base-directive','text!./style.css', 'text!./view.html', 'underscore', "moment",
  ...
  class ComponentDevicemonitorDirective extends base.BaseDirective
    constructor: ($timeout, $window, $compile, $routeParams, commonService)->
      @id = "component-devicemonitor"
...
#        console.log $("#graphicparamter").width()
  ...
  exports =
    ComponentDevicemonitorDirective: ComponentDevicemonitorDirective