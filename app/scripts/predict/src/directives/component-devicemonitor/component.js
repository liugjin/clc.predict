...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment", './models/paging-model', './modules/signal-manager', './modules/event-manager', './modules/command-manager', 'tripledes'], function(base, css, view, _, moment, pm, sm, em, cm, CryptoJS) {
  var ComponentDevicemonitorDirective, exports;
  ComponentDevicemonitorDirective = (function(_super) {
    var sortFunction;

    __extends(ComponentDevicemonitorDirective, _super);

    function ComponentDevicemonitorDirective($timeout, $window, $compile, $routeParams, commonService) {
      ...
      this.id = "component-devicemonitor";
      ComponentDevicemonitorDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
      this.currStation = null;
      this.currEquipment = null;
    }

    ComponentDevicemonitorDirective.prototype.setScope = function() {};

    ComponentDevicemonitorDirective.prototype.setCSS = function() {
      return css;
    };

    ComponentDevicemonitorDirective.prototype.setTemplate = function() {
      return view;
    };

    ComponentDevicemonitorDirective.prototype.show = function(scope, element, attrs) {
      var _ref, _ref1;
    ...
    ComponentDevicemonitorDirective.prototype.confirmEquipmentEvent2 = function(event, comment, forceToEnd) {
      var data;
      data = event.getIds();
    ...
    ComponentDevicemonitorDirective.prototype.confirmData = function(data, comment, forceToEnd) {
    ...
    ComponentDevicemonitorDirective.prototype.confirmEquipmentEvents2 = function(equipment, comment, forceToEnd) {
      var data;
    ...
    ComponentDevicemonitorDirective.prototype.executeCommand2 = function(command, comment) {
    ...
    ComponentDevicemonitorDirective.prototype.cancelCommand2 = function(command, comment) {
      var data, k, v, _ref;
      if (!command._data) {
        return;
      }
    ...
    ComponentDevicemonitorDirective.prototype.resetEquipment = function() {
    ...
    ComponentDevicemonitorDirective.prototype.loadSignals = function(equipment, callback, refresh) {
    ...
    ComponentDevicemonitorDirective.prototype.loadEvents = function(equipment, callback, refresh) {
    ...
    ComponentDevicemonitorDirective.prototype.loadCommands = function(equipment, callback, refresh) {
    ...
    ComponentDevicemonitorDirective.prototype.initializeSignal = function(signal, equipment) {
    ...
    ComponentDevicemonitorDirective.prototype.initializeEvent = function(event, equipment) {
      var instance, _ref;
      if (equipment == null) {
        equipment = this.equipment;
      }
    ...
    ComponentDevicemonitorDirective.prototype.initializeCommand = function(command, equipment) {
      var instance, _ref;
      if (equipment == null) {
        equipment = this.equipment;
      }
    ...
    ComponentDevicemonitorDirective.prototype.subscribeSignals = function(equipment) {
    ...
    ComponentDevicemonitorDirective.prototype.processSignalData = function(data) {
    ...
    ComponentDevicemonitorDirective.prototype.updateDuration = function(scope) {
    ...
    ComponentDevicemonitorDirective.prototype.subscribeSignalStatistics = function(equipment) {
      var filter, model, _ref;
      if (equipment == null) {
        equipment = this.equipment;
      }
    ...
    ComponentDevicemonitorDirective.prototype.subscribeEvents = function(equipment) {
      var filter, model, _ref;
      if (equipment == null) {
        equipment = this.equipment;
      }
    ...
    ComponentDevicemonitorDirective.prototype.processEventData = function(event) {
    ...
    ComponentDevicemonitorDirective.prototype.processActiveEvent = function(event) {
    ...
    ComponentDevicemonitorDirective.prototype.subscribeCommands = function(equipment) {
      var filter, model, _ref;
      if (equipment == null) {
        equipment = this.equipment;
      }
    ...
    ComponentDevicemonitorDirective.prototype.queryRecentSignalRecords = function(signal) {
    ...
    ComponentDevicemonitorDirective.prototype.querySignalRecords = function(signal) {
      return this.signalManager.queryRecords(signal);
    };

    ComponentDevicemonitorDirective.prototype.queryEventRecords = function(event) {
      return this.eventManager.queryRecords(event);
    };

    ComponentDevicemonitorDirective.prototype.queryCommandRecords = function(command) {
      return this.commandManager.queryRecords(command);
    };

    ComponentDevicemonitorDirective.prototype.processCommandData = function(data) {
    ...
    ComponentDevicemonitorDirective.prototype.clearSignalRecords = function() {
      this.signalRecords.setItems([]);
      return this.signalRecordsParameters = {};
    };

    ComponentDevicemonitorDirective.prototype.clearEventRecords = function() {
      this.eventRecords.setItems([]);
      return this.eventRecordsParameters = {};
    };

    ComponentDevicemonitorDirective.prototype.clearCommandRecords = function() {
      this.commandRecords.setItems([]);
      return this.commandRecordsParameters = {};
    };

    ComponentDevicemonitorDirective.prototype.loadEquipmentGraphic = function(equipment, refresh) {
    ...
    ComponentDevicemonitorDirective.prototype.connect = function(data, callback) {
      var url;
    ...
    ComponentDevicemonitorDirective.prototype.filterEquipment = function() {
    ...
    ComponentDevicemonitorDirective.prototype.selectSignalGroup = function(group) {
      return this.signalGroup = group;
    };

    ComponentDevicemonitorDirective.prototype.filterEvent = function() {
      return (function(_this) {
        return function(event) {
          var text;
    ...
    ComponentDevicemonitorDirective.prototype.selectEventGroup = function(group) {
      return this.eventGroup = group;
    };

    ComponentDevicemonitorDirective.prototype.filterCommand = function() {
      return (function(_this) {
        return function(command) {
          var text;
    ...
    ComponentDevicemonitorDirective.prototype.selectCommandGroup = function(group) {
      return this.commandGroup = group;
    };

    ComponentDevicemonitorDirective.prototype.validateCommandPassword = function(callback) {
    ...
    ComponentDevicemonitorDirective.prototype.encrypt = function(value, key) {
      var encryptedValue;
      return encryptedValue = CryptoJS.DES.encrypt(value, key).toString();
    };

    ComponentDevicemonitorDirective.prototype.decrypt = function(encryptedValue, key) {
      var value;
      value = CryptoJS.DES.decrypt(encryptedValue, key);
      return value = CryptoJS.enc.Utf8.stringify(value);
    };

    ComponentDevicemonitorDirective.prototype.moreMessage = function() {
    ...
    ComponentDevicemonitorDirective.prototype.saveValue = function(value) {
      return this.oldValue = value;
    };

    ComponentDevicemonitorDirective.prototype.checkValue = function(value) {
    ...
    ComponentDevicemonitorDirective.prototype.setYScale = function() {
    ...
    ComponentDevicemonitorDirective.prototype.resize = function(scope) {
    ...
    ComponentDevicemonitorDirective.prototype.dispose = function(scope) {
      var _ref, _ref1;
    ...
    return ComponentDevicemonitorDirective;
