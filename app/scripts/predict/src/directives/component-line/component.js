...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment", "echarts"], function(base, css, view, _, moment, echarts) {
  var ComponentLineDirective, exports;
  ComponentLineDirective = (function(_super) {
    __extends(ComponentLineDirective, _super);

    function ComponentLineDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "component-line";
      ComponentLineDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    ComponentLineDirective.prototype.setScope = function() {};

    ComponentLineDirective.prototype.setCSS = function() {
      return css;
    };

    ComponentLineDirective.prototype.setTemplate = function() {
      return view;
    };

    ComponentLineDirective.prototype.show = function(scope, element, attrs) {
    ...
    ComponentLineDirective.prototype.resize = function(scope) {
    ...
    ComponentLineDirective.prototype.dispose = function(scope) {
      var _ref;
      return (_ref = scope.mychart) != null ? _ref.dispose() : void 0;
    };

    return ComponentLineDirective;
