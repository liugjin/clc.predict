...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var EventAnalysisDirective, exports;
  EventAnalysisDirective = (function(_super) {
    __extends(EventAnalysisDirective, _super);

    function EventAnalysisDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.processEvents = __bind(this.processEvents, this);
      this.show = __bind(this.show, this);
      this.id = "event-analysis";
      EventAnalysisDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    EventAnalysisDirective.prototype.setScope = function() {};

    EventAnalysisDirective.prototype.setCSS = function() {
      return css;
    };

    EventAnalysisDirective.prototype.setTemplate = function() {
      return view;
    };

    EventAnalysisDirective.prototype.show = function(scope, element, attrs) {
      var filter, station, subject, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      scope.alarms = {};
      scope.types = [];
      scope.predicts = _.filter(scope.project.stations.items, function(sta) {
        return _.isEmpty(sta.model.parent) && sta.model.station.charAt(0) !== "_";
      });
      scope.parents = [];
      this.findParent(scope, scope.station);
      scope.stations = (_ref = (_ref1 = scope.parents[0]) != null ? _ref1.stations : void 0) != null ? _ref : scope.predicts;
      ...
      scope.selectParent = function(station) {
        ...
        return scope.stations = (_ref4 = (_ref5 = station.parentStation) != null ? _ref5.stations : void 0) != null ? _ref4 : scope.predicts;
      };
      if (scope.firstload) {
    ...
    EventAnalysisDirective.prototype.processEvents = function(scope) {
    ...
    EventAnalysisDirective.prototype.findParent = function(scope, station) {
      var parent;
    ...
    EventAnalysisDirective.prototype.resize = function(scope) {};

    EventAnalysisDirective.prototype.dispose = function(scope) {};

    return EventAnalysisDirective;
