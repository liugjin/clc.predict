...
define ['../base-directive','text!./style.css', 'text!./view.html', 'underscore', "moment"], (base, css, view, _, moment) ->
  class EventAnalysisDirective extends base.BaseDirective
    ...
    show: (scope, element, attrs) =>
      ...
      scope.predicts = _.filter scope.project.stations.items, (sta)->_.isEmpty(sta.model.parent) and sta.model.station.charAt(0) isnt "_"
      scope.parents = []
      @findParent scope, scope.station
      scope.stations = scope.parents[0]?.stations ? scope.predicts
...
#第一次把所有站点的告警加载处理
  ...
  exports =
    EventAnalysisDirective: EventAnalysisDirective