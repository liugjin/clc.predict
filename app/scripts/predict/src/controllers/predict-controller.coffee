...
define ['clc.foundation.angular/controllers/project-base-controller'], (base) ->
  class PredictController extends base.ProjectBaseController
    constructor: ($scope, $rootScope, $routeParams, $location, $window, $timeout, modelManager, modelEngine, uploadService, @predictService, options) ->
...
#
#      @predictService.echo parameters, (err, result) =>
#        @echoResult = result
