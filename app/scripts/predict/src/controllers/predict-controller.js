...
define(['clc.foundation.angular/controllers/project-base-controller'], function(base) {
  var PredictController, exports;
  PredictController = (function(_super) {
    __extends(PredictController, _super);

    function PredictController($scope, $rootScope, $routeParams, $location, $window, $timeout, modelManager, modelEngine, uploadService, predictService, options) {
      this.predictService = predictService;
      PredictController.__super__.constructor.call(this, $scope, $rootScope, $routeParams, $location, $window, $timeout, modelManager, modelEngine, uploadService, options);
    }

    PredictController.prototype.onLoad = function(callback, refresh) {
      return this.load(callback, refresh);
    };

    PredictController.prototype.load = function(callback, refresh) {
      this.myproject = this.modelEngine.storage.get('myproject');
      return this.loadProjects(callback, refresh);
    };

    PredictController.prototype.loadProjects = function(callback, refresh) {
