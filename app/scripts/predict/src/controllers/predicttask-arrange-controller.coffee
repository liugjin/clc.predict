###
* File: predicttask-arrange-controller
* User: Pu
* Date: 2020/03/16
* Desc: 
###
...
define ['clc.foundation.angular/controllers/project-base-controller'], (base) ->
  class PredicttaskArrangeController extends base.ProjectBaseController
  ...
  exports =
    PredicttaskArrangeController: PredicttaskArrangeController
