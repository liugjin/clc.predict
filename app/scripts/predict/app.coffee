...
define ['angular', './routes', 'socketio', 'clc.foundation.angular/app-manager',
  ...
  app = angular.module 'app', ['ngRoute', 'angularLocalStorage', 'angularMoment', 'btford.socket-io', 'angular-timeline', 'angular.filter', 'pascalprecht.translate', 'clc.predict']

  manager = new am.AppManager app
  manager.config 'predict', routes
  manager.connect io
